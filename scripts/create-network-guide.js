...
import { ExternalLink, Check, Info, AlertTriangle, Monitor, Smartphone, Zap, Search, ChevronRight } from 'lucide-react';
...
`;
const fsDir = 'src/app/guides/ai-network';
if (!fs.existsSync(fsDir)) {
  fs.mkdirSync(fsDir, { recursive: true });
}
fs.writeFileSync(fsDir + '/page.tsx', pageContent);
console.log('Created /guides/ai-network/page.tsx');
