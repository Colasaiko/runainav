...
const functionIndex = c.indexOf('export default async function AIToolPage');
const returnIndex = c.indexOf('return (', functionIndex);
...
const beforeReturn = c.substring(0, returnIndex);
const standardReturnAndAfter = c.substring(returnIndex);
