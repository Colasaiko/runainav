      ...
      <section className="mt-16 bg-blue-50/50 dark:bg-blue-900/10 rounded-2xl p-8 border border-blue-100 dark:border-blue-800/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link href="/guides/chatgpt-what-can-it-do" className="flex items-start gap-3 p-4 rounded-xl hover:bg-white dark:hover:bg-gray-800 transition-colors group">
            <div className="p-2 bg-blue-100 dark:bg-blue-900/50 rounded-lg group-hover:scale-110 transition-transform"><Sparkles className="w-4 h-4 text-blue-700 dark:text-blue-300"/></div>
            <div>
          ...
          <Link href="/guides/chatgpt-pdf-guide" className="flex items-start gap-3 p-4 rounded-xl hover:bg-white dark:hover:bg-gray-800 transition-colors group">
            <div className="p-2 bg-indigo-100 dark:bg-indigo-900/50 rounded-lg group-hover:scale-110 transition-transform"><FileText className="w-4 h-4 text-indigo-700 dark:text-indigo-300"/></div>
            <div>
          ...
          <Link href="/tests/chatgpt" className="flex items-start gap-3 p-4 rounded-xl hover:bg-white dark:hover:bg-gray-800 transition-colors group">
            <div className="p-2 bg-emerald-100 dark:bg-emerald-900/50 rounded-lg group-hover:scale-110 transition-transform"><Check className="w-4 h-4 text-emerald-700 dark:text-emerald-300"/></div>
            <div>
          ...
          <Link href="/guides/chatgpt-jichang" className="flex items-start gap-3 p-4 rounded-xl hover:bg-white dark:hover:bg-gray-800 transition-colors group">
            <div className="p-2 bg-orange-100 dark:bg-orange-900/50 rounded-lg group-hover:scale-110 transition-transform"><Globe className="w-4 h-4 text-orange-700 dark:text-orange-300"/></div>
            <div>
...
chatgptGuides.forEach(slug => {
  ...
  if (fs.existsSync(filePath)) {
    ...
    // Find where the article ends. Usually right before </article> or </main>
