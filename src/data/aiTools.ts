...
export const aiTools: AITool[] = [
  ...
  },
  {
    ...
    logo: '/images/ai/jasper.png',
    logoSource: 'https://cdn.prod.website-files.com/6807ee8d73c233fb82842313/681e121b52f97ed0b2098aab_Favicon.png',
    category: 'productivity',
    categories: ['productivity', 'chat'],
    region: 'global',
  ...
  },
  {
    ...
    logo: '/images/ai/copy-ai.png',
    logoSource: 'https://cdn.prod.website-files.com/628288c5cd3e8411b90a36a4/6793eea386b5ac27242bb8eb_favicon_32x32px%20(1).png',
    category: 'productivity',
    categories: ['productivity', 'chat'],
    region: 'global',
  ...
  },
  {
    ...
    screenshots: [
      {
        src: "/images/ai/screenshots/claude/chat.webp",
        alt: "Claude官方对话界面",
        caption: "Claude官方对话界面",
...
包含于 Adobe Creative Cloud 订阅中，提供免费试用额度，具体价格请以官方页面当前显示为准。`,
  ...
  },
  {
    ...
    features: ['高度优化的底层算法支持', '开箱即用的现代化交互界面', '稳定且极速的云端并发响应'],
    useCases: ['自动化处理高频重复任务', '跨领域专业内容的快速起草', '为复杂设计与决策提供思路'],
    gettingStarted: ['注册并完成基础环境与偏好配置', '跟随官方指引完成首个任务', '探索插件生态与高级自定义选项'],
    networkAndRegion: '国内可用',
    advantages: ['依托顶尖研发团队的底层模型', '每周高频的功能与体验迭代', '精准切中原生工作流的核心痛点'],
    limitations: ['深度进阶功能依赖于 Pro 订阅', '高级 API 及参数调节需要一定的上手时间'],
    faq: [
    ...
    screenshots: [
      {
        src: "/images/ai/screenshots/jimeng/chat.webp",
        alt: "即梦AI官方生成界面",
        caption: "即梦AI官方生成界面",
    ...
    screenshots: [
      {
        ...
        alt: "可灵AI官方产品界面",
        caption: "可灵AI官方产品界面",
        source: "https://klingai.kuaishou.com"
      }
    ],
...
- [Civitai 模型社区](https://civitai.com/)`,
    ...
    logo: '/images/ai/synthesia.png',
    logoSource: 'https://cdn.prod.website-files.com/65e89895c5a4b8d764c0d710/664f0f482fa5a4d527d892bc_Favicon-Web-Security%201.png',
    category: 'video',
    ...
    logoSource: 'https://cdn.prod.website-files.com/66b3765153a8a0c399c70981/670cb2af23deffa700aa8a09_favicon.ico',
    category: 'music',
    categories: ["audio","productivity"],
    ...
    logoSource: 'https://cdn.prod.website-files.com/618e9316785b3582a5178502/618e94bcbca88b51e2ad81f7_favicon.png',
    category: 'video',
