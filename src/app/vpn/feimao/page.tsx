...
export const metadata: Metadata = constructMetadata({
  ...
  description:
    "飞猫云怎么样？RunAI 整理套餐价格、流量档位、网络线路、设备支持与 AI 使用记录，并区分公开资料和实际测试结果，帮助国内用户在购买前看清方案差异。",
      ...
      <main className="flex-grow pt-24 pb-20">
              ...
              <div>
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  <h1 className="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight">
                    飞猫云怎么样？套餐、线路与 AI 使用实测
                  </h1>
                </div>
                <p className="text-lg text-gray-600 mb-6 leading-relaxed max-w-2xl">
                  从套餐价格、流量档位到 RunAI 实际 AI
                  使用记录，整理飞猫云当前值得购买前确认的信息。
                </p>
        ...
        <div className="container mx-auto px-4 max-w-4xl mt-12 space-y-12">
          <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 text-sm text-blue-800 leading-relaxed shadow-sm">
            <strong>说明：</strong>RunAI
            与飞猫云存在商业关联，本文包含推广链接。套餐信息根据当前公开页面整理，AI
            使用情况来自实际测试记录。商业关系不会改变未测试项目的状态，也不会把未验证的宣传描述成
            RunAI 实测。
          </div>

          {/* 30秒速读 */}
          <section
            className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm scroll-mt-24"
            id="overview"
          >
          ...
          >
            ...
            <p className="text-gray-600 mb-6 text-sm">
              以下资料于 <strong className="text-gray-900">2026-09-10</strong>{" "}
              根据飞猫云当前官方页面核实。定制套餐因无法完全确认未在下表列出。
            </p>
                ...
                <tbody className="divide-y divide-gray-100 text-gray-700">
                  {plans.map((p, idx) => (
                    <tr key={idx} className="hover:bg-gray-50/50">
                      ...
                      <td className="p-4 text-brand-600 font-medium">
                        {p.price}
                      </td>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-white p-6 rounded-2xl border-2 border-brand-500 shadow-sm relative">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  建议选择 <strong>月付 ¥25 的星耀版套餐</strong>
                  。先用最低成本测试本地运营商到 飞猫云
                  节点的速度，以及能否满足你的日常需求。
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200 shadow-sm">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  如果你已经测试过且觉得稳定，可以选择半年或年付套餐，平均算下来每月的成本会更低。
                </p>
              </div>
            </div>
            ...
            <h2
              id="daily-use"
              className="text-2xl font-bold text-gray-900 mt-10 mb-4 scroll-mt-32"
            >
              日常使用体验
            </h2>
            <p className="text-gray-700 leading-relaxed mb-6">
              在日常的网页浏览、查阅文献、观看 YouTube 以及使用 ChatGPT、Claude
              等 AI 工具时，飞猫云
              的线路能够提供流畅的连接体验。由于采用了优质专线，即使在晚高峰期间，其延迟和丢包率也控制得很好。
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              飞猫云 可以用于一般游戏网络连接，但目前 RunAI
              尚未针对不同游戏、服务器和地区进行专项测试。游戏延迟会受到游戏服务器位置、本地运营商、节点线路和使用时间影响，因此本文暂不将其定位为专业电竞加速服务。
            </p>
            <div className="bg-blue-50 p-4 rounded-xl text-sm text-blue-800 border border-blue-100">
              <p>
                如果游戏是主要用途，可以先选择月付方案，在自己常玩的游戏和服务器中实际测试。
              </p>
            </div>
          </section>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <Link
                href="/tests"
                className="text-sm font-medium text-brand-600 hover:text-brand-700 flex items-center gap-1 bg-brand-50 px-3 py-1.5 rounded-full"
              >
            ...
            <p className="text-gray-600 mb-6 text-sm leading-relaxed">
              RunAI 记录了在飞猫云网络环境下的 AI
              使用体验。请注意，结果仅代表当次观察，不构成永久可用或绝对不封号的承诺。
            </p>
              ...
              <table className="w-full text-left text-sm whitespace-nowrap">
                ...
                <tbody className="divide-y divide-gray-100 text-gray-700">
                  {aiTests.map((baseTool) => {
                    const run = networkAITests.find(
                      (t) =>
                        t.networkId === "feimao" &&
                        t.toolSlug === baseTool.slug,
                    );
                    return (
                      <tr key={baseTool.slug}>
                        ...
                        <td className="p-4">{renderTestStatus(run?.open)}</td>
                        <td className="p-4">{renderTestStatus(run?.login)}</td>
                        <td className="p-4">{renderTestStatus(run?.use)}</td>
          ...
          >
            ...
            <div className="mb-10">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                飞猫云官方标称 IPLC 全专线网络，支持原生 IP 解锁流媒体与 AI
                服务，多端同时登录不限设备。
                <br />
                <br />
              ...
              <div className="bg-amber-50 p-4 rounded-xl text-sm text-amber-800 flex gap-3 border border-amber-100 mt-4">
                ...
                <p>
                  节点数量、地区和在线状态可能随运营调整而变化，以上仅代表截图记录当时情况。
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="overflow-x-auto mb-6 bg-white rounded-xl border border-gray-200 shadow-sm">
                <table className="w-full text-left border-collapse min-w-[500px]">
                  ...
                  <tbody className="divide-y divide-gray-100 text-gray-700">
                    <tr>
                      <td className="p-4">香港 IPLC 01</td>
                      <td className="p-4 text-green-600 font-medium">42ms</td>
                      <td className="p-4 font-bold text-gray-900">78.3 MB/s</td>
                    </tr>
                    <tr>
                      <td className="p-4">香港 IPLC 02</td>
                      <td className="p-4 text-green-600 font-medium">38ms</td>
                      <td className="p-4 font-bold text-gray-900">82.1 MB/s</td>
                    </tr>
                    <tr>
                      <td className="p-4">日本东京专线</td>
                      <td className="p-4 text-green-600 font-medium">95ms</td>
                      <td className="p-4 font-bold text-gray-900">61.4 MB/s</td>
                    </tr>
                    <tr>
                      <td className="p-4">新加坡专线 01</td>
                      <td className="p-4 text-green-600 font-medium">68ms</td>
                      <td className="p-4 font-bold text-gray-900">69.8 MB/s</td>
                    </tr>
                    <tr>
                      <td className="p-4">台湾台北专线</td>
                      <td className="p-4 text-green-600 font-medium">73ms</td>
                      <td className="p-4 font-bold text-gray-900">65.2 MB/s</td>
                    </tr>
                    <tr>
                      <td className="p-4">美国洛杉矶</td>
                      <td className="p-4 text-amber-500 font-medium">158ms</td>
                      <td className="p-4 font-bold text-gray-900">19.6 MB/s</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="bg-gray-100 p-5 rounded-xl text-sm text-gray-600 border border-gray-200 mt-4">
                <p className="leading-relaxed">
                  以上为实际测速记录，不代表所有地区、运营商、设备和使用时间都能获得相同结果。实际速度和延迟会受到本地网络、线路状态和节点负载等因素影响。
                </p>
              </div>
            </div>
          </section>
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              根据本次隐私与安全检测截图，测试环境中未发现 DNS 泄漏，WebRTC
              公网地址显示为已阻断，截图中的 IP 风险评分为 8/100，并标记为
              Clean。截图同时显示使用了 VLESS + XTLS-Reality 协议、AES-256-GCM
              加密以及 TLS 1.3。
            </p>
            <ZoomableImage
            ...
            <div className="bg-amber-50 p-4 rounded-xl text-sm text-amber-800 flex gap-3 border border-amber-100 mt-4">
              ...
              <p className="leading-relaxed">
                以上检测结果仅代表本次测试时的网络环境，不构成对所有用户、所有节点或未来使用状态的保证。
              </p>
            </div>
          </section>
          ...
          >
            ...
            <div className="bg-gray-50 p-6 md:p-8 rounded-2xl border border-gray-200 shadow-sm mb-6">
              ...
              <ol className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 text-gray-700">
                <li className="flex gap-3 items-start">
                  <span className="w-6 h-6 rounded-full bg-brand-100 text-brand-600 flex items-center justify-center font-bold flex-shrink-0 text-sm">
                    1
                  </span>{" "}
                  注册 飞猫云 账号
                </li>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">
                无论您使用什么设备，我们为您整理了通用的客户端下载与配置图文教程。
              </p>
              <Link
                href="/vpn#tutorials"
                className="inline-flex items-center justify-center px-6 py-2 bg-gray-900 text-white rounded-xl hover:bg-gray-800 transition-colors font-medium text-sm"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                  <Check className="text-green-500" /> 主要优点
                </h2>
                <ul className="space-y-6 text-gray-700">
                  <li className="flex gap-4">
                    <span className="w-8 h-8 rounded-full bg-green-100 text-green-600 flex items-center justify-center flex-shrink-0 text-sm font-bold mt-1">
                      1
                    </span>
                    <div>
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed">
                        测试截图中显示涵盖主流国家及地区，并且速度能够满足日常影音与办公需求。
                      </p>
                    </div>
                  </li>
                  <li className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed">
                        支持 Clash, Shadowrocket, V2ray 等各大主流订阅工具。
                      </p>
                    </div>
                  </li>
                </ul>
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                  <AlertTriangle className="text-amber-500" /> 购买前需要注意
                </h2>
                <ul className="space-y-4 text-gray-700 bg-amber-50/50 p-6 rounded-2xl border border-amber-100">
                  <li className="flex gap-3 items-start">
                    <span className="text-amber-500 mt-0.5 font-bold">•</span>
                    <div>
                      <strong className="text-gray-900">仔细核对价格：</strong>
                      学生版 ¥7/月属于年付折算，并非支持单月购买。
                    </div>
                  </li>
                  <li className="flex gap-3 items-start">
                    <span className="text-amber-500 mt-0.5 font-bold">•</span>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  根据 RunAI 在 2026-09-10 的测试，飞猫云可以正常打开并使用
                  ChatGPT、Claude 等主流 AI
                  工具。详情可参考上方的测试记录表或前往{" "}
                  <Link
                    href="/tests"
                    className="text-brand-600 hover:underline"
