    ...
    <div className="bg-gray-50 min-h-screen pb-20">
      ...
      <div className="container mx-auto px-4 max-w-4xl mt-12">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-wrap gap-4 justify-center">
          <Link href="/ai" className="px-6 py-2.5 bg-gray-900 text-white rounded-full font-medium hover:bg-gray-800 transition-colors">查看全部 AI 工具</Link>
          {tool.region === 'china' && <Link href="/ai/china" className="px-6 py-2.5 bg-blue-50 text-blue-700 rounded-full font-medium hover:bg-blue-100 transition-colors border border-blue-200">查看更多国内 AI 工具</Link>}
          {tool.region === 'global' && <Link href="/ai/global" className="px-6 py-2.5 bg-purple-50 text-purple-700 rounded-full font-medium hover:bg-purple-100 transition-colors border border-purple-200">查看更多国外 AI 工具</Link>}
        </div>
