      ...
      <section className="mt-16 bg-teal-50/50 dark:bg-teal-900/10 rounded-2xl p-8 border border-teal-100 dark:border-teal-800/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Link href="/guides/cursor-build-blog" className="flex items-start gap-3 p-4 rounded-xl hover:bg-white dark:hover:bg-gray-800 transition-colors group">
            ...
            <div>
              <div className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Cursor 从零建站实战</div>
              <div className="text-sm text-gray-500 dark:text-gray-400">小白也能一键生成个人博客</div>
            </div>
          </Link>
  
          <Link href="/guides/cursor-copilot-timeout" className="flex items-start gap-3 p-4 rounded-xl hover:bg-white dark:hover:bg-gray-800 transition-colors group">
            <div className="p-2 bg-teal-100 dark:bg-teal-900/50 rounded-lg group-hover:scale-110 transition-transform">💻</div>
            <div>
              <div className="font-semibold text-gray-900 dark:text-gray-100 mb-1">代码补全超时排查</div>
              <div className="text-sm text-gray-500 dark:text-gray-400">解决 Cursor 连通性问题</div>
            </div>
          </Link>
  
          <Link href="/guides/cursor-pro-buy" className="flex items-start gap-3 p-4 rounded-xl hover:bg-white dark:hover:bg-gray-800 transition-colors group">
            <div className="p-2 bg-teal-100 dark:bg-teal-900/50 rounded-lg group-hover:scale-110 transition-transform">💻</div>
            <div>
