        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 lg:col-start-2">
            <div className="prose prose-lg prose-brand max-w-none text-gray-700">
              ...
              <h2 id="intro">前言介绍</h2>
              <p>在网络世界中，高效、稳定的连接是每个人追求的目标。IPLC、IEPL、中转和直连经常出现在机场宣传里，但它们并不是简单的高低等级。本文整理常见线路概念、成本、延迟和稳定性差异，并说明选购时该看哪些实际指标。</p>
              ...
              <ul>
                ...
                <li><a href="https://jichang.blog" target="_blank" rel="noopener noreferrer">机场Blog</a> - 一句话说明为什么值得读。</li>
