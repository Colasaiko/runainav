        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 lg:col-start-2">
            <div className="prose prose-lg prose-brand max-w-none text-gray-700">
              ...
              <h2 id="intro">前言介绍</h2>
              <p>在网络世界中，高效、稳定的连接是每个人追求的目标。节点延迟很低不代表实际速度一定快。本文整理 URL Test、延迟、抖动、丢包、下载速度和晚高峰测试的区别，并给出轻度到重度的测试流程，帮助更全面判断节点质量。</p>
              ...
              <ul>
                <li><a href="https://jichangmao.com" target="_blank" rel="noopener noreferrer">机场猫</a> - 一句话说明为什么值得读。</li>
